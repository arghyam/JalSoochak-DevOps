...
DELETE FROM common_schema.tenant_config_master_table a USING common_schema.tenant_config_master_table b
WHERE
    a.id > b.id
...
CREATE UNIQUE INDEX uq_tenant_config_key ON common_schema.tenant_config_master_table (tenant_id, config_key)
